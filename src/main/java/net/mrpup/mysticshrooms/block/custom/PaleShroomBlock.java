...
public class PaleShroomBlock extends HorizontalFacingBlock {
    public static final MapCodec<PaleShroomBlock> CODEC = createCodec(PaleShroomBlock::new);
    ...
    public PaleShroomBlock(Settings settings) {
        super(settings);
    }
